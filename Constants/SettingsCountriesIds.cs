...
public static class SettingsCountriesIds
{
    public const string CountriesSection = "settings-countries";
    public const string CountriesHeader = "countries-header";
    ...
    public const string TestName = "Test Country";
