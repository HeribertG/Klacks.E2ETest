...
public static class SettingsOwnerAddressIds
{
    ...
    public const string SettingOwnerAddressEmail = "setting-owner-address-email";
    public const string SettingOwnerAddressStreet = "setting-owner-address-street";
    public const string SettingOwnerAddressZip = "setting-owner-address-zip";
    public const string SettingOwnerAddressCity = "setting-owner-address-city";
}
