...
public static class SettingsWorkSettingIds
{
    public const string Container = "work-setting-container";
    public const string Header = "work-setting-header";
    public const string Form = "work-setting-form";
